...
function RightMiddle(props) {
    return (
<svg id="RightMiddle" class="finger" overflow="visible" width="41" height="152" viewBox="0 0 41 152" fill="none" xmlns="http://www.w3.org/2000/svg">
