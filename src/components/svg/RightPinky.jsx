...
function RightPinky({blink}) {
    return (
<svg id="RightPinky" class={"finger" + (blink? " blink" : "")}  overflow="visible" width="34" height="108" viewBox="0 0 34 108" fill="none" xmlns="http://www.w3.org/2000/svg">
