...
function RightRing(props) {
    return (
<svg id="RightRing" class="finger" overflow="visible" width="41" height="144" viewBox="0 0 41 144" fill="none" xmlns="http://www.w3.org/2000/svg">
